...
A standalone Lean 4 / Mathlib formalisation of these claims is in
`lean_project_template/ShadowProof/DemorganSymmetry.lean`.  The runtime
`shadowproof demorgan-symmetry` and `bilattice_axiom_report()` are the
in-process counterparts of the same statements.
...
- Diligence reading index: `docs/acquisition/DILIGENCE_INDEX.md`; the v0.25.6 patch status is in `docs/acquisition/DILIGENCE_STATUS.md`.
...
`docs/acquisition/DILIGENCE_INDEX.md`; the v0.25.6 patch status is in `docs/acquisition/DILIGENCE_STATUS.md`.
